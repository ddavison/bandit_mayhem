...
###
class Editor
  tool_belt: document.getElementById('tool-belt')  # the element where we'll put the tool belt
  tool_list: document.getElementById('tool-list')  # the element where we'll put the tool list
